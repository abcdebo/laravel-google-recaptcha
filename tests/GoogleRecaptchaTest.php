...
use ABCDebo\GoogleRecaptcha\GoogleRecaptcha;
...
class GoogleRecaptchaTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        parent::setUp();
        $this->captcha = new GoogleRecaptcha('{secret-key}', '{site-key}');
    }
    ...
    {
        $this->assertTrue($this->captcha instanceof GoogleRecaptcha);
